...
public class TelephonyManagerWrapper {
    ...
    private static final HashMap<Integer, String> mServiceStates = new HashMap<Integer, String>();
    static {
            ...
            for (Field serviceState : serviceStates) {
                ...
                if (serviceState.getType().equals(Integer.TYPE)
                    ...
                    try {
                        ...
                        mServiceStates.put(serviceState.getInt(null), serviceState.getName());
    ...
    private static final HashMap<Integer, String> mNetworkTypes = new HashMap<Integer, String>();
    static {
        // populate the constant map using reflection
        ...
        if (networkTypes != null) {
            for (Field networkType : networkTypes) {
                ...
                if (networkType.getType().equals(Integer.TYPE)
                    ...
                    try {
                        // map the int value to the constant name
                        mNetworkTypes.put(networkType.getInt(null), networkType.getName());
                    } catch (IllegalArgumentException e) {
    ...
    public static String getServiceStateName(int serviceState) {
        return mServiceStates.get(serviceState);
    }
